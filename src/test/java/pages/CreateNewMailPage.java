...
public class CreateNewMailPage extends AbstractPage{
    ...
    @FindBy(xpath = "//div[@data-title='Сохранить']")
    ...
    public void fields(String addressee, String subject, String body)
    {
        ...
        driver.switchTo().frame(driver.findElement(By.xpath("//*[@id='b-toolbar__right']/div[3]/div/div[2]/div[2]/div")));
        driver.findElement(By.xpath("//div[@data-title='Сохранить']")).click();
